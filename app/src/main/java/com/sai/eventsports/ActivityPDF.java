...
public class ActivityPDF extends AppCompatActivity {
    ...
    private String pintarPDF() {
        String html = "<h2>POLÍTICA DE PRIVACIDAD DE EVENTSPORTS</h2>";
        html += "<p>El presente Política de Privacidad establece los términos en que EventSports usa y protege la" +
                ...
                "<br>EventSports está altamente comprometido para cumplir con el compromiso de mantener su información" +
                ...
                " EventSports Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en" +
                " cualquier momento.</p>";
        return html;
    }
}